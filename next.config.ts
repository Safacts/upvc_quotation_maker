...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [{
      source: "/:path*",
      headers: [
         { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://www.gstatic.com https://umami.novamymentor.cloud https://pagead2.googlesyndication.com https://apis.google.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https:; connect-src 'self' https://*.supabase.co https://*.supabase.com https://gumpmnbjdtzajhysnnaz.supabase.co https://jqjxhhgfwdzckijnnede.supabase.co https://t3.ftcdn.net https://umami.novamymentor.cloud https://pagead2.googlesyndication.com https://apis.google.com https://accounts.google.com https://www.gstatic.com https://fonts.gstatic.com wss:; font-src 'self' data: https://fonts.gstatic.com; frame-src 'self' https://accounts.google.com https://play.google.com; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self' https://*.vercel.app https://app.vitharn.com" },
