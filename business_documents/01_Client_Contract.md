...
*Professional. Authoritative. Transparent.*
...
This Agreement is made between **Vitharn ERP Services** (“Agency”) and the Client named below, and sets out the strict terms under which our automated ERP and Quotation services will be provided.
...
### 2.5 Strict Confidentiality & Data Isolation
Both parties agree to keep confidential any non-public information shared. Vitharn explicitly guarantees strict Row-Level Security (RLS) data isolation; no client data will ever bleed into another tenant's instance.
...
By signing below, both parties agree to the terms of this Agreement and acknowledge the Vitharn standard of excellence.
