      ...
      <section className="pricing-hero pricing-hero-grid">
        <div className="pricing-hero-inner">
          ...
          <p className="hero-subtitle">
            ...
            EvaERP serves 3,000+ UPVC <strong>manufacturers</strong>, but it&apos;s built for factories — not fabricators.
            Vitharn is built <strong>only for your business</strong>. Here&apos;s the difference.
          </p>
          <p className="hero-subtitle" style={{ marginTop: 16, fontSize: 20, fontWeight: 600, color: "#EA580C" }}>
            <strong>EvaERP is built for factories.</strong> <span style={{ color: "#1A0A00" }}>We&apos;re built for fabricators.</span>
          </p>
        </div>
      </section>
