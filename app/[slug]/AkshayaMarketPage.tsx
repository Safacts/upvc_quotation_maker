...
const AKSHAYA_LOGO_MARK = "/akshaya/images/logo-mark.svg";
      ...
      <header className={"ak-header " + (scrolled ? "is-scrolled" : "")}>
        <div className="ak-container ak-header-inner">
          <a href="#top" className="ak-brand" onClick={closeMenu}>
            <img className="ak-brand-logo" src={AKSHAYA_LOGO_MARK} alt={brandName + " logo"} width={46} height={46} />
