...
export default function VenkateshwaraMarketPage({ client, slug }: Props) {
  const cfg = parseClientConfig(client.config || {}, client.id);

  // Business Meta
  const brandName = cfg.companyName || "Sri Venkateshwara UPVC Windows & Doors";
  const proprietor = cfg.companyProprietor || "J. Venkatesh";
  const phone = cfg.companyContact || "+91 99890 28453";
  const email = cfg.companyEmail || "jvenkateshupvc@gmail.com";
  const address = cfg.companyAddress || "Hyderabad, Telangana, India";
  const rawWhatsapp = phone.replace(/\D/g, "");
  const whatsappNum = rawWhatsapp.length === 10 ? `91${rawWhatsapp}` : rawWhatsapp;
  ...
  const sqft = Math.max(1, calcWidth * calcHeight);
  ...
  const whatsappQuoteMsg = encodeURIComponent(
    `Hello ${proprietor}! I visited your Venkateshwara UPVC website and calculated an estimate for:\n\n` +
  ...
  const handleLeadSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/${whatsappNum || "919989028453"}?text=${msg}`, "_blank");
    setFormSent(true);
  };
  ...
  return (
    <div className="venkateshwara-root">
          ...
          <div className="v-topbar-inner">
            <div className="v-topbar-left">
              <span className="v-badge-pill">
                <Sparkles size={12} /> HYDERABAD'S PREMIER UPVC FABRICATOR
              </span>
        ...
        <div className="v-container">
          <div className="v-header-inner">
            <a href="#hero" className="v-logo-brand">
              <div className="v-logo-emblem">V</div>
            ...
            <div className="v-header-actions">
              <a href={`https://wa.me/${whatsappNum || "919989028453"}?text=${encodeURIComponent("Hi Venkatesh! I am looking for UPVC windows/doors for my home.")}`} target="_blank" rel="noreferrer" className="v-btn-primary v-btn-whatsapp">
          ...
          <div className="v-hero-grid">
            ...
            >
              ...
              <p className="v-hero-desc">
                Hyderabad’s premier custom manufacturer of soundproof, rainproof & energy-efficient UPVC windows and doors. Designed for extreme monsoon durability and zero maintenance.
              </p>
              ...
              <div className="v-hero-cta">
                ...
                <a href={`tel:${phone.replace(/\s+/g, "")}`} className="v-btn-secondary">
                  <Phone size={16} /> Call J. Venkatesh
                </a>
              </div>
            ...
            >
              ...
              <div style={{ marginTop: "24px", paddingTop: "18px", borderTop: "1px solid var(--v-border)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontSize: "13px", color: "#94a3b8" }}>Free Hyderabad Measurement</span>
        ...
        <div className="v-container">
          <div className="v-section-header">
            ...
            <p className="v-section-desc">
              Get an accurate estimate for your home or villa in 10 seconds. Select your specifications below and directly send the blueprint to J. Venkatesh for fabrication.
            </p>
          </div>
              ...
              <div className="v-calc-summary-panel">
                ...
                <div className="v-calc-total-box">
                  ...
                  <div className="disclaimer">
                    Includes fabrication, high-grade hardware & delivery in Hyderabad.
                  </div>
                </div>

                <a
                  href={`https://wa.me/${whatsappNum || "919989028453"}?text=${whatsappQuoteMsg}`}
                  target="_blank"
                  rel="noreferrer"
                  className="v-btn-primary v-btn-whatsapp"
                  style={{ width: "100%", justifyContent: "center" }}
                >
                  <MessageCircle size={16} /> WhatsApp This Quote to J. Venkatesh
                </a>
              </div>
            </div>
          </div>
      ...
      <section id="products" className="v-section">
        <div className="v-container">
          <div className="v-section-header">
            ...
            <h2 className="v-section-title">Architectural Systems Built for Hyderabad</h2>
            <p className="v-section-desc">
          ...
          <div className="v-product-grid">
            ...
            <div className="v-product-card">
              ...
              <a href={`https://wa.me/${whatsappNum}?text=${encodeURIComponent("Hi, I want a quote for 2/3 Track Sliding Windows.")}`} target="_blank" rel="noreferrer" className="v-btn-secondary" style={{ marginTop: "auto" }}>
            ...
            <div className="v-product-card">
              ...
              <a href={`https://wa.me/${whatsappNum}?text=${encodeURIComponent("Hi, I want a quote for Casement Openable Windows.")}`} target="_blank" rel="noreferrer" className="v-btn-secondary" style={{ marginTop: "auto" }}>
            ...
            <div className="v-product-card">
              ...
              <a href={`https://wa.me/${whatsappNum}?text=${encodeURIComponent("Hi, I want a quote for Villa Security Windows.")}`} target="_blank" rel="noreferrer" className="v-btn-secondary" style={{ marginTop: "auto" }}>
            ...
            <div className="v-product-card">
              ...
              <a href={`https://wa.me/${whatsappNum}?text=${encodeURIComponent("Hi, I want a quote for French Doors.")}`} target="_blank" rel="noreferrer" className="v-btn-secondary" style={{ marginTop: "auto" }}>
            ...
            <div className="v-product-card">
              ...
              <a href={`https://wa.me/${whatsappNum}?text=${encodeURIComponent("Hi, I want a quote for Tilt & Turn Windows.")}`} target="_blank" rel="noreferrer" className="v-btn-secondary" style={{ marginTop: "auto" }}>
            ...
            <div className="v-product-card">
              ...
              <a href={`https://wa.me/${whatsappNum}?text=${encodeURIComponent("Hi, I want a quote for Custom Arch Windows & Facades.")}`} target="_blank" rel="noreferrer" className="v-btn-secondary" style={{ marginTop: "auto" }}>
      ...
      <section id="soundproofing" className="v-section v-section-alt">
        <div className="v-container">
          <div className="v-section-header">
            ...
            <h2 className="v-section-title">Block Hyderabad City Noise (35dB+ Drop)</h2>
            <p className="v-section-desc">
              Living near main roads, metro lines, or bustling markets? Sri Venkateshwara UPVC windows with Double Glazed Units (DGU) turn noisy chaos into quiet library peace.
            </p>
          </div>
          ...
          <div className="v-acoustic-box">
            ...
            <div className="v-sound-meter">
              ...
              <div className="v-sound-bar" style={{ borderColor: "#10b981", background: "rgba(16, 185, 129, 0.08)" }}>
                <div className="v-sound-bar-header">
                  <span style={{ color: "#34d399", fontWeight: 700 }}>Sri Venkateshwara DGU UPVC Window</span>
              ...
              <div style={{ background: "rgba(0, 210, 255, 0.1)", padding: "16px", borderRadius: "12px", border: "1px solid rgba(0, 210, 255, 0.3)", textAlign: "center" }}>
                <span style={{ fontSize: "13px", color: "#00d2ff", fontWeight: 600 }}>
                  ✨ Experience deep sleep and peaceful work-from-home focus.
                </span>
              </div>
            </div>
          </div>
      ...
      <section id="engineering" className="v-section">
        <div className="v-container">
          <div className="v-section-header">
            ...
            <h2 className="v-section-title">The Anatomy of a Venkateshwara UPVC Window</h2>
            <p className="v-section-desc">
        ...
        <div className="v-container">
          ...
          <div className="v-process-grid">
            <div className="v-process-card">
              ...
              <p>Our expert visits your site in Hyderabad with samples and takes laser-accurate measurements.</p>
            </div>
            <div className="v-process-card">
            ...
            <div className="v-process-card">
              ...
              <p>Precision corner fusion welding and steel reinforcement at our modern Hyderabad facility.</p>
            </div>
            <div className="v-process-card">
              <div className="v-step-num">04</div>
              <h4>Clean Installation</h4>
              <p>Dust-protected installation by trained company specialists backed by a 10-year warranty card.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="reviews" className="v-section">
        <div className="v-container">
          <div className="v-section-header">
            ...
            <h2 className="v-section-title">Trusted by 500+ Hyderabad Homeowners</h2>
            <p className="v-section-desc">
              See what architects, interior designers, and villa owners say about Sri Venkateshwara UPVC Windows & Doors.
            </p>
          </div>
          ...
          <div className="v-review-grid">
            <div className="v-review-card">
              <div>
                ...
                <p className="v-review-quote">
                  "J. Venkatesh and his team completed 18 villa windows for our Kokapet residence. The soundproofing against outer highway noise is unbelievable. Very honest pricing and delivered right on time."
                </p>
              </div>
              <div className="v-reviewer-meta">
                ...
                <div className="v-reviewer-info">
                  ...
                  <p>Villa Owner, Kokapet, Hyderabad</p>
                </div>
              </div>
            </div>
            ...
            <div className="v-review-card">
              <div>
                ...
                <p className="v-review-quote">
                  "We installed 3-track sliding balcony doors with mosquito mesh in our high-rise apartment in Gachibowli. Heavy monsoon rains had zero leakage. The sliding action is super smooth."
                </p>
              </div>
              <div className="v-reviewer-meta">
                ...
                <div className="v-reviewer-info">
                  ...
                  <p>Apartment Owner, Gachibowli</p>
                </div>
              </div>
            </div>
            ...
            <div className="v-review-card">
              <div>
                ...
                <p className="v-review-quote">
                  "As an interior designer in Jubilee Hills, I regularly recommend Sri Venkateshwara UPVC. Venkatesh personally inspects every site and ensures perfect corner finishes and top-tier German hardware."
                </p>
              </div>
              <div className="v-reviewer-meta">
                ...
                <div className="v-reviewer-info">
                  <h5>Ananya Narang</h5>
                  <p>Architect & Interior Consultant, Hyderabad</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="v-contact-card">
            <div>
              ...
              <p style={{ color: "#94a3b8", fontSize: "14px", lineHeight: 1.7, margin: "0 0 28px" }}>
                Speak directly with proprietor <strong>{proprietor}</strong>. We will visit your site anywhere in Hyderabad, bring profile samples, and provide a digital itemized quotation with zero obligation.
              </p>
              ...
              <div className="v-contact-info-list">
                ...
                <div className="v-contact-item">
                  ...
                  <div className="v-contact-text">
                    ...
                    <p><a href={`https://wa.me/${whatsappNum}?text=${encodeURIComponent("Hello Venkatesh! I want a site visit.")}`} target="_blank" rel="noreferrer" style={{ color: "#00d2ff", textDecoration: "none" }}>Chat with J. Venkatesh</a></p>
                  </div>
                </div>
            ...
            <div style={{ background: "rgba(10, 19, 36, 0.85)", padding: "32px", borderRadius: "20px", border: "1px solid var(--v-border)" }}>
              ...
              {formSent ? (
                <div style={{ background: "rgba(16, 185, 129, 0.15)", border: "1px solid rgba(16, 185, 129, 0.4)", borderRadius: "12px", padding: "20px", textAlign: "center" }}>
                  ...
                  <p style={{ color: "#94a3b8", fontSize: "13px", margin: 0 }}>WhatsApp chat opened with J. Venkatesh. We will be in touch shortly!</p>
                </div>
              ) : (
      ...
      <footer className="v-footer">
        <div className="v-container">
          <div className="v-footer-grid">
            <div className="v-footer-brand">
              <div style={{ display: "flex", alignItems: "center", gap: "10px", color: "#fff", fontWeight: 700, fontSize: "17px" }}>
                <div className="v-logo-emblem" style={{ width: "36px", height: "36px", fontSize: "16px" }}>V</div>
                {brandName}
              </div>
              <p>
                Authorized manufacturer and installer of precision-engineered UPVC window & door systems for residential villas, apartments and commercial projects across Telangana.
              </p>
            </div>
            ...
            <div className="v-footer-col">
              ...
              <ul className="v-footer-links">
                ...
                <li><a href="#contact">Kukatpally & Miyapur</a></li>
                <li><a href="#contact">Secunderabad & Kompally</a></li>
              </ul>
            </div>
          ...
          <div className="v-footer-bottom">
            <div>
              © {new Date().getFullYear()} {brandName}. All rights reserved. Made in Hyderabad.
            </div>
            <div>
      ...
      <div className="v-floating-bar">
        ...
        <a
          href={`https://wa.me/${whatsappNum || "919989028453"}?text=${encodeURIComponent("Hello Venkatesh! I visited your website and would like a quote for UPVC windows.")}`}
          target="_blank"
          rel="noreferrer"
