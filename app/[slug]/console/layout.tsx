...
export default async function ConsoleLayout({
  ...
  // receive a fully rendered shell â€” leaking their company name and logo out of
  ...
  // include the console, gets an upgrade prompt â€” NOT a redirect to /upvc/login.
  ...
  if (!access.ok && access.upgradeRequired) {
    ...
    // installed but NOT wired in this repo â€” utility classes compile to nothing
    ...
    return (
      <div className="vc-upgrade-gate">
        <div className="vc-upgrade-card">
          ...
          <p className="vc-upgrade-plan">Included with the Final plan â€” Rs. 55,000</p>
